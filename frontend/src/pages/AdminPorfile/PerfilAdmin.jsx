...
const PerfilAdmin = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        /*
        const res = await fetch("https://bluefruitnutrition-production.up.railway.app/api/users/profile", {
          headers: {
  ...
  const handleLogout = async () => {
    try {
      ...
      await fetch("https://bluefruitnutrition-production.up.railway.app/api/logout", {
        method: "POST",
        credentials: "include",
      });
    } catch (error) {
